...
const DEFAULT_REGION = process.env.NEXT_PUBLIC_DEFAULT_REGION || "gf"
...
export const config = {
  matcher: [
    "/((?!api|store|admin|app|static|health|_next/static|_next/image|favicon.ico|images|assets|png|svg|jpg|jpeg|gif|webp).*)",
  ],
}
